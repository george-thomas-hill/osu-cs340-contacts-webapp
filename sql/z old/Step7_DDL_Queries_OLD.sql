...
CREATE TABLE `contacts` (
  ...
  CONSTRAINT `contacts_fk_user` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON DELETE CASCADE -- GH added ON DELETE CASCADE 2020-03-14
...
INSERT INTO `contacts` VALUES (1,1,'Jung','Jordan','617-555-1004','jordan@example.com','Owes me $15.',NULL),(2,1,'Smith','Sydney','617-555-1005','sydney@example.com','Has a dog.',1),(3,1,'Rogers','Robin','617-555-1006','robin@example.com','Software engineer.',NULL),(4,2,'Moore','Murphy','617-555-1007','murphy@example.com','Birthday is Jan. 1.',NULL),(5,2,'Hall','Hollis','617-555-1008','hollis@example.com','',4),(6,2,'Brown','Brighton','617-555-1009','brighton@example.com','',NULL);
...
CREATE TABLE `interactionDetails` (
  ...
  CONSTRAINT `interactionDetails_fk_comType` FOREIGN KEY (`comId`) REFERENCES `communicationModes` (`comId`) ON DELETE CASCADE, -- GH added ON DELETE CASCADE 2020-03-14
  CONSTRAINT `interactionDetails_fk_interaction` FOREIGN KEY (`interactId`) REFERENCES `interactions` (`interactId`) ON DELETE CASCADE -- GH added ON DELETE CASCADE 2020-03-14
...
CREATE TABLE `interactions` (
  ...
  -- KEY `interactions_fk_user` (`userId`), -- GH commented this out 2020-03-14
  KEY `interactions_fk_contact` (`contactId`),
  -- CONSTRAINT `interactions_fk_user` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`), -- GH commented this out 2020-03-14
  CONSTRAINT `interactions_fk_contact` FOREIGN KEY (`contactId`) REFERENCES `contacts` (`contactId`) ON DELETE CASCADE -- GH added ON DELETE CASCADE 2020-03-14
...
INSERT INTO `interactions` VALUES (1,1,'2000-01-01'),(2,1,'2000-01-02'),(3,1,'2000-01-03'),(4,1,'2000-01-13');
...
-- Dump completed on 2020-03-02 14:38:33
